...
//        percentDemo();
    ...
    private void taskDemo(){
        ...
        // Future - об'єкт мови програмування, що відповідає за задачі (C# - Task, JS - Promise, Python - Coroutine)
        ...
        try {
            pool.awaitTermination(15000, TimeUnit.MILLISECONDS); // даємо час на завершення наявних задач
        }
        catch (InterruptedException ignored) {}
